...
Finishing my M.Tech thesis on **HetSpA** — a class-conditioned, bicycle-decoded attention model that predicts multimodal vehicle motion on lane-free Indian roads, with every trajectory physically drivable by construction. Pooled best-of-six minADE **0.436 m** over 12,762 vehicles under a leakage-free vehicle-ID protocol, plus a diagnostic that asks *what in the scene actually carries the predictive signal*. Manuscript in preparation for **Transportation Research Part C**.
